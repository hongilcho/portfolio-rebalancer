...
print(f"Total Portfolio KRW: {total_portfolio_krw}, Available Cash: {available_cash_pool}, Total Buy Needed: {total_buy_needed}")
for aid in buy_targets:
    print(f"Before Scale: {buy_targets[aid]['name']}, diff_qty: {buy_targets[aid]['diff_qty']}")
...
print(f"Remaining cash: {rem_cash}")
while rem_cash > 0:
    best_aid = None
    max_shortfall = 0
...
for aid, t in buy_targets.items():
    print(f"Final buy: {t['name']}, diff_qty: {t['diff_qty']}")
